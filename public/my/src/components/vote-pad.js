...
export default function Main() {
  return (
    <div className="vote-box">
      <div className="party">
        <button id="one">
          <img src="../Bharatiya_Janata_Party_logo.svg.png" className="party-logo" />
        </button>
      ...
      <div className="party">
        <button id="two">
          <img src="../Indian_National_Congress_hand_logo.png" className="party-logo" />
        </button>
      ...
      <div className="party">
        <button id="three">
          <img src="../aap.png" className="party-logo" />
        </button>
      ...
      <div className="party">
        <button id="four">
          <img src="../nota.png" className="party-logo" />
        </button>
